...
namespace DL.Common.Tests.Data
{
    ...
    {
        private SqlParameterFactory target;
        ...
        public void TestInitialize()
        {
            ...
            this.target = new SqlParameterFactory(factory.CreateCommand());
        ...
        public void Make_NameAndType_Equal()
        {
            ...
            // act
            var parameter = this.target.Make(this.parameterName, databaseType) as SqlParameter;
        ...
        public void Make_NameAndBooleanTrue_Equal()
        {
            ...
            // act
            var parameter = this.target.Make(this.parameterName, parameterValue) as SqlParameter;

            // assert
            Assert.AreEqual("test", parameter.ParameterName);
            Assert.AreEqual(DbType.Boolean, parameter.DbType);
            Assert.AreEqual(SqlDbType.Bit, parameter.SqlDbType);
        ...
        public void Make_NameAndDateTimeNotNull_Equal()
        {
            ...
            Assert.AreEqual(SqlDbType.DateTime, parameter.SqlDbType);
        ...
        public void Make_NameAndDateTimeOffsetNotNull_Equal()
        {
            ...
            Assert.AreEqual(SqlDbType.DateTimeOffset, parameter.SqlDbType);
            Assert.AreEqual(parameterValue, parameter.Value);
        }
        ...
        public void Make_NameAndDecimalNonZero_Equal()
        {
            ...
            Assert.AreEqual(SqlDbType.Decimal, parameter.SqlDbType);
        ...
        public void Make_NameAndDoubleNonZero_Equal()
        {
            ...
            Assert.AreEqual(SqlDbType.Float, parameter.SqlDbType);
