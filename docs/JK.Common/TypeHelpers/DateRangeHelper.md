[Docs](../../README.md) > [JK.Common](../README.md) > DateRangeHelper
...
- **startOne** — The start date of range one.

- **endOne** — The end date of range one.

- **startTwo** — The start date of range two.

- **endTwo** — The end date of range two.
