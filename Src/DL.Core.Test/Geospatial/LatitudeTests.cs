...
namespace DL.Core.Test.Geospatial
{
    ...
    public class LatitudeTests
    {
        ...
        {
            var latitude = new Latitude();
            latitude.SetCoordinate(40.44611m);
        ...
        {
            var latitude = new Latitude();
            latitude.SetCoordinate(40.44611m, Direction.N);
        ...
        {
            var latitude = new Latitude(40.44611m);
            this.AssertCoordinateData(latitude);
        }
        ...
        {
            var latitude = new Latitude(40.44611m, Direction.N);
            this.AssertCoordinateData(latitude);
        }
        ...
        {
            Assert.AreEqual(40.44611m, latitude.DecimalDegreesSigned);
