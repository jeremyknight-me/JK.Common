...
public static class DecimalExtensions
{
    ...
    public static long GetDecimalPart(this decimal value) => DecimalHelper.GetDecimalPart(value);
    ...
    public static long GetWholePart(this decimal value) => DecimalHelper.GetWholePart(value);
}
