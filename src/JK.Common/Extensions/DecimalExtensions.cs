...
public static class DecimalExtensions
{
    ...
    public static decimal GetDecimalPart(this decimal value) => DecimalHelper.GetDecimalPart(value);
    ...
    public static decimal GetWholePart(this decimal value) => DecimalHelper.GetWholePart(value);
}
