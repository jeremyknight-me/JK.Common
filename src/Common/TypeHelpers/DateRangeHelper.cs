...
public static class DateRangeHelper
{
    ...
    /// <param name="startOne">The start date of range one.</param>
    /// <param name="endOne">The end date of range one.</param>
    /// <param name="startTwo">The start date of range two.</param>
    /// <param name="endTwo">The end date of range two.</param>
