...
public class EnumHelperTests
{
    ...
    */
    ...
    {
        var actual = EnumHelper.GetAttribute<DisplayAttribute>(Colors.Blue);
    ...
    {
        var actual = EnumHelper.GetAttribute<DisplayAttribute>(Colors.Green);
        Assert.Null(actual);
    }
    ...
    {
        var ex = Assert.Throws<ArgumentException>(() => EnumHelper.GetByByte<byte>(0));
    ...
    {
        var ex = Assert.Throws<ArgumentOutOfRangeException>(() => EnumHelper.GetByByte<Colors>(invalidValue));
    }

    [Fact]
    public void GetByByte_ValidOrdinal()
    {
        var actual = EnumHelper.GetByByte<Colors>(2);
    ...
    {
        var ex = Assert.Throws<ArgumentException>(() => EnumHelper.GetByInteger<int>(0));
        Assert.Equal("T must be an enumerated type", ex.Message);
    }
    ...
    {
        var ex = Assert.Throws<ArgumentOutOfRangeException>(() => EnumHelper.GetByInteger<Colors>(invalidValue));
    }

    [Fact]
    public void GetByInteger_ValidOrdinal()
    {
        var actual = EnumHelper.GetByInteger<Colors>(2);
        Assert.Equal(Colors.Green, actual);
    }
    ...
    {
        int actual = EnumHelper.GetInteger(Colors.Green);
        Assert.Equal(2, actual);
    }
    ...
    {
        int? actual = EnumHelper.GetInteger((Colors?)null);
        Assert.Null(actual);
    }
    ...
    {
        int? actual = EnumHelper.GetInteger((Colors?)Colors.Green);
        Assert.Equal(2, actual);
    }
